...
class Transacoes:
    ...
    def atualizar_preco_medio(self, custo_unitario, quantidade):
        ...
        logging.info(
            f"Atualizando preço médio: custo_unitario={custo_unitario}, quantidade={quantidade}"
        )

        logging.info(
            f"Antigo: custo_total={self.custo_total}, quantidade_total={self.quantidade_total}"
        )
        ...
        logging.info(
            f"Novo: custo_total={self.custo_total}, quantidade_total={self.quantidade_total}"
        )
    ...
    def calcular_lucro(self, preco_venda, quantidade):
        ...
        logging.info(
            f"Calculando lucro: preco_venda={preco_venda}, quantidade={quantidade}, preco_medio={self.preco_medio_calculado}, lucro={lucro}"
        )
        return lucro
